...
class AppStrings {
  ...
  String currentSong(String title) => tr('現在の曲: $title', 'Current song: $title');
  ...
  String get arrangerStep1 => tr('楽譜を登録してチームに共有', 'Register score and share with teammates');
  String get arrangerStep2 => tr('MIDIを登録してチームに共有', 'Register MIDI and share with teammates');
  String get arrangerStep3 => tr('曲を選択して練習開始を案内', 'Select a song and guide team to start practice');
  String get arrangerPrimaryAction => tr('楽譜/MIDIを登録する', 'Register score/MIDI');

  String get practitionerStep1 => tr('楽譜・MIDIをダウンロード', 'Download score and MIDI');
  String get practitionerStep2 => tr('MIDIを流しながら録音', 'Record while playing MIDI');
  String get practitionerStep3 => tr('トラック別に共有・取得', 'Share and fetch takes by track');
  String get practitionerPrimaryAction => tr('練習セッションへ', 'Go to practice session');

  String get evaluatorStep1 => tr('対象曲を選択', 'Select target song');
  String get evaluatorStep2 => tr('第三者レビューと評価を記入', 'Write third-party review and rating');
  String get evaluatorStep3 => tr('評価結果を共有', 'Share review result');
  String get evaluatorPrimaryAction => tr('評価を記入する', 'Write evaluation');

  String get selectMusicXmlSong =>
      tr('ライブラリでMusicXML付きの曲を選択してください。', 'Select a MusicXML song from Library.');
  ...
  String guideVolumeLabel(int percent) => tr('ガイド音量 $percent%', 'Guide Volume $percent%');
  String startPositionLabel(String sec) => tr('開始位置: ${sec}s', 'Start position: ${sec}s');
  ...
  String get midiStaffHint => tr('MIDIをもとに指定トラックを五線譜表示', 'Render selected MIDI track on staff');
  String get mixer => tr('ミキサー', 'Mixer');
  String trackCountLabel(int count) => tr('トラック数: $count', 'Track count: $count');
  ...
  String trackVolumeLabel(int percent) => tr('音量: $percent%', 'Volume: $percent%');
  String get teammateTrackDownloads => tr('チームメイト音声（トラック別）', 'Teammate Track Audio');
  String teammateTakeTitle(int trackNo, String userId) => tr('Track $trackNo - $userId', 'Track $trackNo - $userId');
  String get myRecording => tr('自分の録音', 'My Recording');
  String trackLabel(int index) => tr('Track $index', 'Track $index');
  String get percussionTrack => tr('Percussion (MIDI Ch.10)', 'Percussion (MIDI Ch.10)');
  ...
  String recordingStatus(bool on) => tr('録音: ${on ? 'ON' : 'OFF'}', 'Recording: ${on ? 'ON' : 'OFF'}');
  ...
  String ratingLabel(int rating) => tr('評価: $rating / 5', 'Rating: $rating / 5');
  ...
  String reviewer(String reviewerId) => tr('評価者: $reviewerId', 'Reviewer: $reviewerId');
  ...
  String get requireProjectId => tr('Project ID は必須です。', 'Project ID is required.');
  String get requireSongFields => tr('Project ID / 曲名 / MIDI key は必須です。', 'Project ID, title, MIDI key are required.');
  String get micRequired => tr('マイク権限が必要です。', 'Microphone permission is required.');
  String get requireSongUserRecording => tr('曲・ユーザー・録音ファイルが必要です。', 'Song, User and recording are required.');
  String fileNotFound(String path) => tr('録音ファイルが見つかりません: $path', 'Recording file does not exist: $path');
  String get takeUploaded => tr('テイクをアップロードしました。', 'Take uploaded and registered.');
  String get copiedScoreDownloadUrl => tr('楽譜ダウンロードURLをコピーしました。', 'Copied score download URL.');
  String get copiedMidiDownloadUrl => tr('MIDIダウンロードURLをコピーしました。', 'Copied MIDI download URL.');
  String get copiedTakeDownloadUrl => tr('トラックダウンロードURLをコピーしました。', 'Copied take download URL.');
  String get requireSongAndReviewer => tr('曲と評価者IDが必要です。', 'Song and reviewer ID are required.');
  String get reviewSubmitted => tr('レビューを送信しました。', 'Review submitted.');
  String get selectSongFirstForTeam => tr('先に曲を選択してください。', 'Select a song first.');
  String get selectAtLeastOneTake => tr('少なくとも1つ選択してください。', 'Select at least one take.');
}
